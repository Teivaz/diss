...
ImpulseResponse = struct('Cluster', Cluster,... % Массив структур Cluster
                         'Size',0,... % Количество кластеров в канале
                         'MaxTime', 0); % Время прихода последнего импульса

% H11 (2-3)
h11_c1 = [1374 0 685.6 893.6 338.2 373.9 0 297.3];
bgn11_c1 = 7.38;
stp11_c1 = 1.2;
h11_c2 = [422.6 297.8 167.4 230.8 266 372.2];
bgn11_c2 = 17.4;
stp11_c2 = 1.2;
h11_c3 = [488.8 311.3 324.6 372.4 180.4];
bgn11_c3 = 24.81;
stp11_c3 = 2;

% H12 (1-3)
h12_c1 = [1276 0 529.8 492.4 267.6 357.6 362.6];
bgn12_c1 = 7.28;
stp12_c1 = 1.14;
h12_c2 = [455 0 263.7 219.8 227.42 221.5];
bgn12_c2 = 15.06;
stp12_c2 = 1.4;
...
% H21 (2-4)
h21_c1 = [1314 321.8 437.7 0 524.3 245];
bgn21_c1 = 7.28;
stp21_c1 = 1.25;
h21_c2 = [610.8	216	392.9	0	295.3];
bgn21_c2 = 15.25;
stp21_c2 = 1.6;
...
% H22
h22_c1 = [1287 617.4 228 545.3 254.7];
bgn22_c1 = 7.22;
stp22_c1 = 2;
h22_c2 = [338.8 279 312.7 297.7];
bgn22_c2 = 17.99;
stp22_c2 = 0.7;
